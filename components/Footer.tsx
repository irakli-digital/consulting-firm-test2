        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <h3 className="text-2xl font-bold">
              Geo<span className="text-teal-light">Permit</span>
            </h3>
            <p className="mt-3 text-sm text-slate-300">{dict.footer.tagline}</p>
          </div>

          {/* Contact */}
          <div>
            <h4 className="font-semibold text-teal-light">{dict.footer.contact}</h4>
          ...
          {/* Social */}
          <div>
            <h4 className="font-semibold text-teal-light">Social</h4>
